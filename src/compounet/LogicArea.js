...
import { add_Friend, updatefriend, deleteFriend, signOut } from '../action'
...
export default connect(mapStateToProps, { add_Friend, updatefriend, deleteFriend, signOut })(LogicArea);